...
vi.mock('./NotificationsBell', () => ({ default: () => <div /> }))
...
/** Opens the panel via the top bar's own trigger, matching how a real click reaches it. */
async function openBugReport() {
  fireEvent.click(screen.getByLabelText('Report a bug'))
  return screen.findByRole('dialog', { name: 'Report a bug' })
}

describe('Navbar + real ReportBugPanel', () => {
